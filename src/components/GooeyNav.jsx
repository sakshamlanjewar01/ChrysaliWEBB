  ...
  `}
      ...
      <div className={`relative ${className}`} ref={containerRef}>
        ...
        >
          <ul
            ref={navRef}
            className="flex gap-2 sm:gap-3 list-none p-0 m-0 relative z-[3]"
            style={{
              color: "white",
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.55em] px-[1em] inline-block text-[12px] sm:text-sm font-semibold tracking-[0.12em]"
                >
                  {item.label}
                </a>
              </li>
